...
# Author: datittran
# Changes: Function class_text_to_int returns index of labels starting at 1
# instead of if/else statements. Uses tensorflow version 1
...
def main(_):
    ...
    writer = tf.python_io.TFRecordWriter(FILE_PATH + '//test.record')
    #Old
